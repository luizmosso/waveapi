...
module.exports = {
    ...
    createToken: (userID) => jwt.sign({ id: userID }, secret, { expiresIn: 86400 }),
    checkToken: (token) => jwt.verify(token, secret, function (err) {if (err) return false; else return true;})
}